  ...
  return (
    <section className="bg-[#FFF9F5] py-16 px-6">
      <div className="max-w-6xl mx-auto">
        {/* Title */}
        <h2 className="text-center text-3xl md:text-4xl font-bold text-brown-900">
          Our Story,{" "}
        ...
        <p className="mt-6 text-lg md:text-xl text-gray-700 leading-relaxed">
          What started as a small kitchen dream has grown into a warm corner
          where every <span className="emoji">🍞</span> loaf, every{" "}
          ...
          <span className="emoji">🧈</span> ingredients, and a touch of passion
          to create baked goods that bring people together.
        </p>
      </div>
    </section>
  );
